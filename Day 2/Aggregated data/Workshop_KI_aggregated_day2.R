...
# Combines first-stage coefficients across regions using random or fixed-effects models (random effects in this study). 
...
# Input parameters:
#   - fun: type of spline ("ns" = natural spline)
